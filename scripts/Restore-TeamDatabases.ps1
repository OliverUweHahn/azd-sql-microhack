...
"@
        ...
        $moveClauses.Add(
            "MOVE N'$escapedLogicalName' TO N'$escapedTargetPath'"
        )
    }
...
"@
    ...
    {
        $restoreOptions.Add($moveClause)
    }

    $restoreOptions.Add("RECOVERY")
    $restoreOptions.Add("STATS = 5")
...
{
    throw @"
The SqlServer PowerShell module could not be loaded.
